...
--
-- Host: localhost    Database: boockshelf_db
-- ------------------------------------------------------
...
CREATE TABLE `books` (
  ...
  `friend_id` smallint DEFAULT NULL,
...
-- Dump completed on 2020-04-14 20:35:56
